<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <div class="w-full mb-4 text-center px-2">
            <h1 class="font-bold text-green-900 leading-none text-base tracking-tight">SISTEMA DE INVENTARIO Y FARMACIA <br>CLINICA VETERINARIA UTM</h1>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="relative px-5">
                <input id="email" class="mt-1 border border-gray-400 outline-none w-full h-8 pl-10 rounded-md shadow" type="email" name="email" :value="old('email')" required autofocus placeholder="Ingrese su correo" />
                <svg class="absolute left-9" style="top: 12px" width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mt-4 relative px-5">
                <input id="password" class="mt-1 border border-gray-400 outline-none w-full h-8 pl-10 rounded-md shadow" type="password" name="password" required autocomplete="current-password" placeholder="Ingrese su contraseña" />
                <svg class="absolute left-9" style="top: 12px" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="w-full mt-4 px-5">
                <button type="submit" class="w-full h-8 bg-green-900 text-white rounded-md font-bold hover:bg-green-800">
                    INGRESAR
                </button>
            </div>
        </form>
