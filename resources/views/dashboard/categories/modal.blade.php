     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 <button type="button" class="bg-green-1000 hover:bg-green-900 shadow-sm p-2 px-4 mt-2 rounded-md text-whire font-medium text-white add_category">{{__('Save')}}</button>
             </div>
         </div>
     </div>
 </div>